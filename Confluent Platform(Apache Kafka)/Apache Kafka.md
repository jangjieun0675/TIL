...
Confluent Control Center는 Apache Kafka의 관리 및 모니터링을 위해 제공되는 GUI 도구입니다. Kafka 클러스터, 브로커, 토픽, 컨슈머 그룹을 모니터링할 수 있는 다양한 기능을 제공합니다.

## 주요 기능

### ① Multi-cluster 통합 모니터링
- 여러 클러스터의 상태를 요약하여 제공합니다.
- 클러스터 간 연결 상태 및 세부 정보를 확인할 수 있습니다.

### ② Broker 통합 모니터링
- 브로커를 통해 메시지 생성 및 소비 상태를 모니터링합니다.
- 브로커의 디스크 사용량, 네트워크 사용량, Kraft 컨트롤러의 연결 상태, 노드 정보를 추적할 수 있습니다.

### ③ Topic 통합 모니터링
- 토픽 추가/삭제와 같은 관리 기능을 제공합니다.
- 토픽의 파티션, 복제 상태, OSR(동기화되지 않은 복제본) 상태를 모니터링할 수 있습니다.

### ④ Consumer Group 통합 모니터링
